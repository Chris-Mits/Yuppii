...
if(mapFooter) {
	...
	footerLighthouseEl.src = "../images/content/svg_icons/LighthousePin.svg";
	footerLighthouseEl.style.width = "30px";
	footerLighthouseEl.style.height = "30px";

	const footerParkEl = document.createElement("img");
	footerParkEl.src = "../images/content/svg_icons/YuppiiLogoPin.svg";
	...
	function activatePopup() {
		...
		if (mobileView.matches) {
			...
			.setHTML(`
				<div class="header">
					<img 
						src="../images/logos/Yuppii Logo Full Black.svg" 
						alt="Logo" />
...
if(mapMain) {
	...
	mainLighthouseEl.src = "../images/content/svg_icons/LighthousePin.svg";
	mainLighthouseEl.style.width = "50px";
	mainLighthouseEl.style.height = "50px";

	const mainParkEl = document.createElement("img");
	mainParkEl.src = "../images/content/svg_icons/YuppiiLogoPin.svg";
